            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('plans.update', $plan->id) }}">
                ...
                <div class="alert alert-info">
                  <i class="fa fa-info-circle"></i> Updating a plan will create a new version. Existing subscriptions will continue with the old plan until renewal.
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="country_id" name="country_id" value="{{ old('country_id', $plan->country_id) }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="billing_cycle" name="billing_cycle" required>
                        ...
                        <option value="quarterly" {{ old('billing_cycle', $plan->billing_cycle) == 'quarterly' ? 'selected' : '' }}>Quarterly (3 months)</option>
                        <option value="half-yearly" {{ old('billing_cycle', $plan->billing_cycle) == 'half-yearly' ? 'selected' : '' }}>Half Yearly (6 months)</option>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control"
                             ...
                             min="0"
                             value="{{ old('category_number', $plan->category_number) }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control"
                             id="total_number_of_dishes"
                             name="total_number_of_dishes"
                             min="0"
                             value="{{ old('total_number_of_dishes', $plan->total_number_of_dishes) }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control"
                             id="total_number_of_table"
                             name="total_number_of_table"
                             min="0"
                             value="{{ old('total_number_of_table', $plan->total_number_of_table) }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control"
                              id="inventory_checkbox"
                              name="inventory_checkbox">
                        <option value="N" {{ old('inventory_checkbox', $plan->inventory_checkbox) == 'N' ? 'selected' : '' }}>No</option>
                        <option value="Y" {{ old('inventory_checkbox', $plan->inventory_checkbox) == 'Y' ? 'selected' : '' }}>Yes</option>
                      </select>
                    </div>
                  </div>
                </div>
