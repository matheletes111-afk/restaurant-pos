              ...
              <form method="POST" action="{{ route('plans.store') }}">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="billing_cycle" name="billing_cycle" required>
                        <option value="yearly" {{ old('billing_cycle', 'yearly') == 'yearly' ? 'selected' : '' }}>Yearly (365 Days)</option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="duration_days" name="duration_days"
                             min="1" value="{{ old('duration_days', 365) }}" required>
                      <small class="text-muted">Auto-filled based on timeframe (e.g. 365 for Yearly, 30 for Monthly)</small>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" name="description"
                            rows="3" placeholder="Describe what this plan includes...">{{ old('description') }}</textarea>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="category_number"
                             ...
                             value="{{ old('category_number', 0) }}" min="0">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="total_number_of_dishes"
                             ...
                             value="{{ old('total_number_of_dishes', 0) }}" min="0">
                      <small class="text-muted">0 = Unlimited</small>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="total_number_of_table"
                             ...
                             value="{{ old('total_number_of_table', 0) }}" min="0">
                      <small class="text-muted">0 = Unlimited</small>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="inventory_checkbox" name="inventory_checkbox">
                        <option value="N" {{ old('inventory_checkbox','N')=='N' ? 'selected' : '' }}>Disabled</option>
                        <option value="Y" {{ old('inventory_checkbox')=='Y' ? 'selected' : '' }}>Enabled</option>
                      </select>
                    </div>
                  </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      function calculateGST() {
        ...
        // Add hidden input fields if you want to send these to backend
        ...
        // Show warning if price is less than GST
        if (price > 0 && price < (gstAmount * 2)) {
      ...
      // Checkbox Y/N value set for default plan
      ...
      // Auto-calculate when price field changes
      $('#price').trigger('input');
