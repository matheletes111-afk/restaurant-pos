<script src="{{asset('public/admin/js/plugins/popper.min.js')}}"></script>
<script src="{{asset('public/admin/js/plugins/simplebar.min.js')}}"></script>
<script src="{{asset('public/admin/js/plugins/bootstrap.min.js')}}"></script>
<script src="{{asset('public/admin/js/fonts/custom-font.js')}}"></script>
<script src="{{asset('public/admin/js/pcoded.js')}}"></script>
<script src="{{asset('public/admin/js/plugins/feather.min.js')}}"></script>
