                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Add Purchase</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="supplier_id" class="form-control select2" required>
                                            ...
                                            @foreach($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}">{{ $supplier->supplier_name }} ({{ $supplier->phone }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="bill_amount" class="form-control" step="0.01" min="0" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <table class="table table-bordered" id="itemsTable">
                                    ...
                                    <tbody id="itemsBody">
                                        ...
                                        <tr id="row_0">
                                            ...
                                            <td>
                                                <input type="number" name="items[0][quantity]" class="form-control quantity" step="0.01" min="0.01" required>
                                            </td>
                                            <td>
                                                <input type="number" name="items[0][price]" class="form-control price" step="0.01" min="0" required>
                                            </td>
                                            <td>
